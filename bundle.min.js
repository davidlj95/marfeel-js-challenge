(function () {
    ...
    class MarfeelDoughnutGramChartService {
    ...
    function randomHistogram(length) {
        const histogram = [];
        for(let i = 1; i <= length; i++) histogram.push(i);
        return shuffle(histogram);
    }

    function noDecimalsEuroFormatter(value) {
     ...
     */
    class MarfeelDoughnutGramChart extends HTMLElement {
        constructor(
            chartData,
            title = "Total",
        ...
        _renderDefaultArcColorsCss() {
            ...
            if(this.colors && this.colors.accents && this.colors.accents.length >= getObjectLength(this.doughnutData)) {
                ...
                for (let i = 0; i < valuesLength; i++) {
                    ...
                    const color = Greys(colorPosition);
        ...
        _renderBaseSvg() {
            return select(this.shadow.getElementById('chart'))
                .append("svg")
        ...
        _createD3PieArcs() {
            ...
            if(this.sort === SORT_DESCENDING) {
                pie$1.sortValues((a, b) => b - a);
            } else if (this.sort === SORT_ASCENDING) {
                pie$1.sortValues((a, b) => a - b);
            }
            return pie$1(entries(this.doughnutData));
        }
        ...
        _renderHistogram(svg) {
            ...
            const y = linear$1()
                .domain([min(this.histogramData), max(this.histogramData)])
